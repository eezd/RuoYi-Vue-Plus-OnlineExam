...
) ENGINE = InnoDB AUTO_INCREMENT = 1972292880988594178 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci COMMENT = '题库分类表' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of edu_question_bank_category
-- ----------------------------
INSERT INTO `edu_question_bank_category` VALUES (1972212094419550209, '000000', 0, '默认分类', NULL, 0, '0', NULL, 103, '2025-09-28 16:09:40', 1, '2025-09-28 16:09:40', 1);
