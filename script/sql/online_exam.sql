...
CREATE TABLE `edu_exam_result`  (
  ...
  `update_by` bigint NULL DEFAULT NULL COMMENT '更新人',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 1 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci COMMENT = '考试结果表' ROW_FORMAT = Dynamic;
...
INSERT INTO `sys_menu` VALUES (1984617292102279169, '考试模块', 1984616504781086721, 1, 'examinationModule', 'online/examinationModule/index', NULL, 1, 0, 'C', '0', '0', NULL, '', 103, 1, '2025-11-01 21:43:30', 1, '2025-11-01 21:47:07', '');
